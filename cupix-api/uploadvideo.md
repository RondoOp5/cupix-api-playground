...
Before start, you need an authentication key. You can see an [in this document](https://github.com/RondoOp5/cupix-api-playground/blob/main/cupix-api/authenticate.md) to get access_token for *x-cupix-auth* key.
